...
import { ChevronUpIcon, ChevronDownIcon, TrashIcon, CopyIcon } from '@renderer/components/icons';
...
export function ConsolePanel({ viewId }: ConsolePanelProps) {
  ...
  const {
    ...
    useShallow((s) => ({
      ...
      getConsoleEntries: s.getConsoleEntries,
      getConsoleCounts: s.getConsoleCounts,
      toggleConsolePanel: s.toggleConsolePanel,
      setConsoleFilter: s.setConsoleFilter,
      clearConsoleEntries: s.clearConsoleEntries,
    }))
  );
