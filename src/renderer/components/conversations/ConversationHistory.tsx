    ...
    <div className="h-full flex flex-col bg-gray-100 dark:bg-neutral-950">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-neutral-700 space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-sky-500 hover:bg-sky-600 text-white rounded transition-colors font-medium"
        >
      ...
      {contextMenu && (
        <>
          ...
          <div
            className="fixed z-50 bg-white dark:bg-neutral-800 rounded shadow-lg border border-gray-200 dark:border-neutral-700 py-1 min-w-[160px]"
