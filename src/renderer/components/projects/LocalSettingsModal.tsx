  ...
  return (
    <Modal title={t('localSettings.title')} onClose={onClose} width="xl">
      <div className="space-y-4">
        ...
        {/* File path */}
        <div className="text-xs text-gray-500 dark:text-gray-500 font-mono bg-gray-100 dark:bg-gray-900 px-3 py-2 rounded">
          ...
          <>
            <div className="relative">
              <textarea
                ...
                className={`w-full h-80 px-3 py-2 text-sm font-mono bg-gray-50 dark:bg-gray-900 border rounded-lg focus:outline-none focus:ring-2 focus:ring-claude-orange/50 resize-none ${
                  parseError
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm bg-claude-orange text-white rounded-lg hover:bg-claude-orange/90 disabled:opacity-50 disabled:cursor-not-allowed"
                >
